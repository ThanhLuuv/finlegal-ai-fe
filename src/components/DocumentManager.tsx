              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-xs text-slate-400 font-normal mt-1.5 flex items-center justify-between gap-2">
                      <span className="truncate">{ext} • {doc.total_pages || 1} MB • {dateStr}</span>
                      <div className="flex items-center gap-1.5 shrink-0">
                        <button
                          ...
                          className="px-2 py-0.5 rounded-md bg-slate-100 hover:bg-blue-50 text-slate-600 hover:text-blue-600 text-[11px] font-semibold flex items-center gap-1 transition-all cursor-pointer"
                          title="Xem file gốc"
                        >
                        ...
                        {!isDemoDoc && (
                          <button
                            ...
                            disabled={isDeleting}
                            className="px-2 py-0.5 rounded-md bg-slate-100 hover:bg-rose-50 text-slate-600 hover:text-rose-600 text-[11px] font-semibold flex items-center gap-1 transition-all cursor-pointer"
                            title="Xóa tài liệu"
                          >
                            {isDeleting ? <Loader2 className="w-3 h-3 animate-spin text-rose-500" /> : <Trash2 className="w-3 h-3 text-slate-500 hover:text-rose-600" />}
                            <span>Xóa</span>
                          </button>
                        )}
                      </div>
